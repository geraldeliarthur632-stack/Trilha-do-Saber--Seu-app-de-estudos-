...
export const QuickExamSimuladoMode: React.FC<QuickExamSimuladoModeProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col justify-between p-4 bg-[#090d16] text-white max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto w-full">
      {/* TOP HEADER */}
      ...
      {!isFinished && currQuestion ? (
        <div className="flex-1 flex flex-col justify-between py-4 space-y-4">
          ...
          {isAnswered && (
            <div className="sticky bottom-2 z-10 pt-2 bg-gradient-to-t from-[#090d16] via-[#090d16] to-transparent pb-1">
              <button
                onClick={handleNextQuestion}
                className="w-full py-3.5 px-6 rounded-2xl bg-[#8b5cf6] hover:bg-[#7c3aed] text-white font-black text-sm transition shadow-lg shadow-purple-600/30 flex items-center justify-center gap-2 active:scale-98 cursor-pointer"
              >

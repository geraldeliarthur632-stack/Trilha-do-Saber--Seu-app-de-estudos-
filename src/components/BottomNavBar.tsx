  ...
  return (
    <nav
      ...
      className={`sticky bottom-0 left-0 right-0 z-40 ${
        isLight
          ? 'bg-white/95 border-t border-slate-200 text-slate-700 shadow-lg'
          : 'bg-[#0b0f19]/95 border-t border-[#1e293b] text-slate-200 shadow-lg'
      } backdrop-blur-lg px-4 py-2 w-full mt-auto shrink-0 pb-[max(0.5rem,env(safe-area-inset-bottom))]`}
      role="navigation"

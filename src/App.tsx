  ...
  return (
    <PortraitContainer themeClass={appTheme === 'light' ? 'theme-light' : 'theme-dark'}>
      <div className="flex-1 flex flex-col h-full w-full min-h-0 overflow-hidden relative">
        {/* FCM Foreground Push Banner for Upcoming Subject Reminders */}
        <FCMForegroundBanner onStartSubject={(subj) => handleStartStudySession(subj)} />
          ...
          {currentMode === 'tabs' && activeTab === 'home' && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-3.5">
                ...
                {/* Explicador IA, Pesquisador IA, Tradutor IA & Resumos em PDF */}
      ...
      {activeReminderToast && (
        <div className="fixed bottom-20 left-4 right-4 max-w-sm mx-auto bg-white text-slate-900 p-3.5 rounded-2xl shadow-xl flex items-center justify-between border border-slate-200 z-50 animate-in fade-in slide-in-from-bottom-2">
